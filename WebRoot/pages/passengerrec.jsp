...
function taxiList(typeValue){
	...
	$.ajax({
 	...
 	/* 	    lon_min = 108.7186431885
		    ...
		    pt = new BMap.Point(108.7186431885, 34.0950320079);
		  	map.addOverlay(new BMap.Marker(pt));
		    pt = new BMap.Point(108.7186431885,34.4711842426);
		  	map.addOverlay(new BMap.Marker(pt));
		  	pt = new BMap.Point(109.1677093506, 34.0950320079);
			map.addOverlay(new BMap.Marker(pt));
			pt = new BMap.Point(109.1677093506,34.4711842426);
			map.addOverlay(new BMap.Marker(pt));
		      */
		 	$.each(data.tapointsList,function(i,point){
