...
<script src="js/jquery/jquery-2.0.2.js" type="text/javascript"></script>
...
<body>
<div id="select">
	<select id="selectType" name="selectType"  onchange="addCustomLayer(this.value);">		                  
    	<option value="59733">陕AT7009</option>
    	<option value="59742">陕AU4815</option>
    </select>
</div>
...
<div id="result">
	 <dl>
       ...
       <dd>
           <ul>
               <li><button id="open">打开</button><button id="close">关闭</button>
           </ul>
       </dd>
</div>
 -->
...
var point = new BMap.Point(108.953098,34.2778);  // 创建点坐标
...
var customLayer;
function addCustomLayer(geotableID) {
    if (customLayer) {
